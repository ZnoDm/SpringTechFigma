...
import com.sinfloo.demo.repository.IRoleRepository;
import com.sinfloo.demo.repository.IUserRepository;
import com.sinfloo.demo.controller.dto.*;
@Service
public class UserServicelmpl implements UserService{
    ...
    public UserServicelmpl(IUserRepository userRepository) {
        super();
        this.userRepository = userRepository;
    }

    @Override
    public User save(UserRegistroDTO registrationDto) {
